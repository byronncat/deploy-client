...
export async function likePost(postId: PostDisplayData['id']): Promise<API> {
  return await axios
    .post(uri.getHostingServer('post/like'), { postId })
    .then((res: AxiosResponse) => res.data)
    .catch((err: any) => err.response.data);
}
...
export async function unlikePost(postId: PostDisplayData['id']): Promise<API> {
  return await axios
    .post(uri.getHostingServer('post/unlike'), { postId })
    .then((res: AxiosResponse) => res.data)
    .catch((err: any) => err.response.data);
}
...
export async function commentPost(
  ...
  return await axios
    .post(uri.getHostingServer('post/comment'), { postId, content })
    .then((res: AxiosResponse) => res.data)
    .catch((err: any) => err.response.data);
}
...
export async function getPostsByUsername(
  ...
  return await axios
    .get(uri.getHostingServer(`post/user/${username}`), { params: { page } })
    .then((res: AxiosResponse) => res.data)
    .catch((err: any) => err.response.data);
}
...
export async function deleteComment(
  ...
  return await axios
    .delete(uri.getHostingServer(`post/${postId}/comments/${commentId}`))
    .then((res: AxiosResponse) => res.data)
    .catch((err: any) => err.response.data);
}